...
async function loadMetroConfigAsync(projectRoot, options, { exp , isExporting , getMetroBundler  }) {
    ...
    if ((ref = exp.experiments) == null ? void 0 : ref.reactServerComponents) {
    ...
    globalThis.__requireCycleIgnorePatterns = (ref1 = config.resolver) == null ? void 0 : ref1.requireCycleIgnorePatterns;
    if (isExporting) {
        var ref7;
        // This token will be used in the asset plugin to ensure the path is correct for writing locally.
        // @ts-expect-error: typed as readonly.
        config.transformer.publicPath = `/assets?export_path=${(((ref7 = exp.experiments) == null ? void 0 : ref7.baseUrl) ?? "") + "/assets"}`;
    } else {
        // @ts-expect-error: typed as readonly
        config.transformer.publicPath = "/assets/?unstable_path=.";
    }
    const platformBundlers = (0, _platformBundlers.getPlatformBundlers)(projectRoot, exp);
    if ((ref2 = exp.experiments) == null ? void 0 : ref2.reactCompiler) {
    ...
    config = await (0, _withMetroMultiPlatform.withMetroMultiPlatformAsync)(projectRoot, {
        ...
        exp,
        platformBundlers,
        isTsconfigPathsEnabled: ((ref3 = exp.experiments) == null ? void 0 : ref3.tsconfigPaths) ?? true,
        isFastResolverEnabled: _env.env.EXPO_USE_FAST_RESOLVER,
        isExporting,
        isReactCanaryEnabled: (((ref4 = exp.experiments) == null ? void 0 : ref4.reactServerComponents) || ((ref5 = exp.experiments) == null ? void 0 : ref5.reactCanary)) ?? false,
        isNamedRequiresEnabled: _env.env.EXPO_USE_METRO_REQUIRE,
        isReactServerComponentsEnabled: !!((ref6 = exp.experiments) == null ? void 0 : ref6.reactServerComponents),
        getMetroBundler
    });
    return {
        config,
